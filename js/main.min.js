...
(freeWindow||freeSelf||{})._=_,"function"==typeof define&&"object"==typeof define.amd&&define.amd&&define(function(){return _}),$provide.constant("lodash",_)}]),function(){"use strict";angular.module("boilerplate",["ngAnimate","ui.bootstrap","boilerplate.components","boilerplate.pages"])}(),function(){"use strict";angular.module("boilerplate.components",[])}(),function(){"use strict";function routeConfig($stateProvider){$stateProvider.state("home",{url:"/",templateUrl:"src/home/home.tpl.html",controller:"HomeCtrl",controllerAs:"homeCtrl"})}routeConfig.$inject=["$stateProvider"],angular.module("boilerplate.pages.home",[]).config(routeConfig)}(),function(){"use strict";function themeConfig($urlRouterProvider){$urlRouterProvider.otherwise("/")}function themeRun($rootScope,$timeout){$timeout(function(){$rootScope.$themeFinishLoading=!0},0)}themeConfig.$inject=["$urlRouterProvider"],themeRun.$inject=["$rootScope","$timeout"],angular.module("boilerplate.pages",["ui.router","boilerplate.pages.home"]).config(themeConfig).run(themeRun)}(),function(){"use strict";function HomeCtrl(){var vm=this;console.log("HOME CTRL",vm)}angular.module("boilerplate.pages.home").controller("HomeCtrl",HomeCtrl)}(),function(){"use strict";function footerCtrl(){var vm=this;console.log("FOOTER COMPONENT",vm)}var footerConfig={bindings:{author:"@",year:"@"},templateUrl:"src/components/footer/footer.tpl.html",controller:footerCtrl,controllerAs:"vm"};angular.module("boilerplate.components").component("mainFooter",footerConfig)}(),function(){"use strict";function headerCtrl(){var vm=this;console.log("HEADER COMPONENT",vm)}var headerConfig={bindings:{projectName:"@"},templateUrl:"src/components/header/header.tpl.html",controller:headerCtrl,controllerAs:"vm"};angular.module("boilerplate.components").component("mainHeader",headerConfig)}();